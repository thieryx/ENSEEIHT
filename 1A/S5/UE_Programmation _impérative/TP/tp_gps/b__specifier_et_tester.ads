...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_specifier_et_tester" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1553a410#;
   pragma Export (C, u00001, "specifier_et_testerB");
   ...
   u00137 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00137, "system__assertionsB");
   u00138 : constant Version_32 := 16#6f8b84a5#;
   pragma Export (C, u00138, "system__assertionsS");
   u00139 : constant Version_32 := 16#96728d28#;
   pragma Export (C, u00139, "ada__assertionsB");
   u00140 : constant Version_32 := 16#d1602bfd#;
