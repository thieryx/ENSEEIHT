...
begin
    ...
    -- Afficher_Deux_Positions (2); --Fonction uniquement dans body et non spécifiée
    New_Line;
    ...
    -- Une_Date.jour := 15; --Variable déclarée dans private
    -- Une_Date.Mois := Mois_Suivant; --Variable déclarée dans private
    Afficher (Une_Date);
    New_Line;
