pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~evaluer_alea_th.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~evaluer_alea_th.adb");
...
package body ada_main is
   ...
   E162 : Short_Integer; pragma Import (Ada, E162, "th_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_evaluer_alea_th");
