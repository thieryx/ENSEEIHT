...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_exemple_unbounded_string" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#af9e5de5#;
   pragma Export (C, u00001, "exemple_unbounded_stringB");
