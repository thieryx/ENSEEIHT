pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~exemple_alea.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~exemple_alea.adb");
...
package body ada_main is
   ...
   E139 : Short_Integer; pragma Import (Ada, E139, "alea_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_exemple_alea");
