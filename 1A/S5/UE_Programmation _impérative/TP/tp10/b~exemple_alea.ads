...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_exemple_alea" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5b025d1b#;
   pragma Export (C, u00001, "exemple_aleaB");
   ...
   u00138 : constant Version_32 := 16#0c378ff0#;
   pragma Export (C, u00138, "aleaB");
   u00139 : constant Version_32 := 16#9fe1c6b1#;
   pragma Export (C, u00139, "aleaS");
   u00140 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00140, "system__random_numbersB");
   u00141 : constant Version_32 := 16#9481a705#;
