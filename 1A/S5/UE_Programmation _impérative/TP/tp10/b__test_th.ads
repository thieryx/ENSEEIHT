...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_th" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a864cb65#;
   pragma Export (C, u00001, "test_thB");
   ...
   u00175 : constant Version_32 := 16#8e7c94d7#;
   pragma Export (C, u00175, "system__storage_pools__subpoolsB");
   u00176 : constant Version_32 := 16#8393ab70#;
   pragma Export (C, u00176, "system__storage_pools__subpoolsS");
   u00177 : constant Version_32 := 16#cafa918a#;
   pragma Export (C, u00177, "system__storage_pools__subpools__finalizationB");
   u00178 : constant Version_32 := 16#8bd8fdc9#;
   pragma Export (C, u00178, "system__storage_pools__subpools__finalizationS");
   u00179 : constant Version_32 := 16#aaa31ead#;
   pragma Export (C, u00179, "thB");
   u00180 : constant Version_32 := 16#cff73901#;
   pragma Export (C, u00180, "thS");
