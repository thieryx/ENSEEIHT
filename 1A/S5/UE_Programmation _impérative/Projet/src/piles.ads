...
-- On reprend le package Piles du TP7 en rajoutant une procedure inverse
generic
...
package Piles is
    ...
    type T_Pile is private; --! "très privé" en Algorithmique !
    ...
    -- Inverse la pile
    procedure Inverser (Pile : in out T_Pile) with
        Pre => not Est_Vide (Pile);
