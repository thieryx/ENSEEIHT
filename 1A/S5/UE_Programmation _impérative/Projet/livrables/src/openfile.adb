...
package body openfile is
    ...
    begin
        ...
        Create (File, Out_File, "texte_compresse.out");
        S := Stream (File);
    ...
    procedure lecture(Tab_Texte : out T_Tab_symbole; Tab_octet : out T_Tab; Tab_arbre : out T_Tab_symbole) is
        File_Name : String :=  "texte_compresse.out";
        S         : Stream_Access;
        Octet     : T_Octet;
    ...
    procedure ecriture_decompress(texte : T_Tab_symbole) is
        S  : Stream_Access;
    begin
        Create (File, Out_File, "texte_decompresse.out");
        S := Stream(File);
