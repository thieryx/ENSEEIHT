...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_piles" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c9595f18#;
   pragma Export (C, u00001, "test_pilesB");
   ...
   u00137 : constant Version_32 := 16#126127bd#;
   pragma Export (C, u00137, "pilesB");
   u00138 : constant Version_32 := 16#28ba0330#;
