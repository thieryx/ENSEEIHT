...
public class ExempleComprendre {
	...
	public static void main(String[] args) {
		...
		afficher("p3", p3);		// Qu'est ce qui est affiché ?
		// Il est affiché "p3 = (100.0, 110.0)"
		// Afficher p1
		afficher("p1", p1);		// Qu'est ce qui est affiché ?
		// Il est affiché "p1 = (100.0, 110.0)"
										// Dessiner l'état de la mémoire
		// Mémoire : p1 ----|
		//                  |--> (100.0, 110.0)
		//           p3 ----|
		...
		p1 = p2 = p3;
										// Dessiner l'état de la mémoire
		afficher("p1", p1);		// Qu'est ce qui est affiché ?
		// Il est affiché "p1 = (123.0, 321.0)"
		afficher("p2", p2);		// Qu'est ce qui est affiché ?
		// Il est affiché "p2 = (123.0, 321.0)"
		afficher("p3", p3);		// Qu'est ce qui est affiché ?
		// Il est affiché "p3 = (123.0, 321.0)"

		// p1, p2 et p3 sont-ils des points différents ?
		// Ces poignées pointent vers la même espace mémoire.
		System.out.println("> p1.translater(-123, -321);");
		p1.translater(-123, -321);
		afficher("p1", p1);		// Qu'est ce qui est affiché ?
		// Il est affiché "p1 = (0.0, 0.0)"
		afficher("p2", p2);		// Qu'est ce qui est affiché ?
		// Il est affiché "p2 = (0.0, 0.0)"
		afficher("p3", p3);		// Qu'est ce qui est affiché ?
		// Il est affiché "p3 = (0.0, 0.0)"
