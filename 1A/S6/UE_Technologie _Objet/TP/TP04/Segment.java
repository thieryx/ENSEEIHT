...
public class Segment {
	...
	*/
	...
	/** Dessiner le segment sur un graphique.
	 * @param E écran d'affichage
	 * @param s segment à afficher
	 * @param c couleur du point
	 */
	public void dessiner(Afficheur E) {
		E.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(), this.extremite2.getX(), this.extremite2.getY(), this.couleur);
	}
}
