...
public class ExempleSchema1 {
	...
	public static void main(String[] args)
	{
		...
		// Afficher graphiquement le schéma
		...
		// Afficher graphiquement le nouveau schéma
		s12.dessiner(E);
		s23.dessiner(E);
		s31.dessiner(E);
		barycentre.dessiner(E);
		...
		AfficheurSVG Ecran = new AfficheurSVG("AfficheurSVG", "Affichage d'un schéma en SVG" ,600, 400);
		s12.dessiner(Ecran);
		s23.dessiner(Ecran);
		s31.dessiner(Ecran);
