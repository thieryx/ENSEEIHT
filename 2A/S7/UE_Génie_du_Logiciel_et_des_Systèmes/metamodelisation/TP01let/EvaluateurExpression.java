...
public class EvaluateurExpression implements VisiteurExpression<Integer> {
	...
	public Integer visiterLet(Let l) {
		Map<String, Integer> env =
				new HashMap<String, Integer>(this.environnement);
		env.put(l.getIdent(), l.getValeur().accepter(this));
		EvaluateurExpression nouveau = new EvaluateurExpression(env);
		return l.getExpression().accepter(nouveau);
	}
