...
instruction_bis : | instruction instruction_bis
/* A FAIRE : Completer pour ajouter les autres formes d'instructions */
               instruction : expression PTVIRG { (print_endline "instruction : expression PTVIRG") }
                             | RETOUR expression PTVIRG  { (print_endline "instruction : RETURN expression PTVIRG") }
														 | SI PAROUV epxresssion PARFER corps { (print_endline "instruction: SI PAROUV epxresssion PARFER corps") }
														 | SI PAROUV epxresssion PARFER corps SINON corps { (print_endline"instruction: SI PAROUV epxresssion PARFER corps SINON corps") }
														 | TANTQUE PAROUV epxression PARFER corps { (print_endline "TANTQUE PAROUV epxression PARFER corps")}
/* A FAIRE : Completer pour ajouter les autres formes d'expressions */

expression: unaires expression 
					| unaires expressions binaire expression
expressions : ENTIER { (print_endline "expression : ENTIER") }
		 ...
		 | NULL { (print_endline "expression : NULL") }
		...
		 | NOUVEAU IDENT CROOUV expression CROFER { (print_endline "expression : NOUVEAU IDENT CROOUV expression CROFER") }
		 | IDENT suffixe_bis { (print_endline "expression : IDENT")}
		 | PAROUV expresssion PARFER suffixe_bis { (print_endline "expression : PAROUV expresssion PARFER suffixe_bis")}
...
suffixe_bis : | suffixe suffixe_bis
unaires : | unaire unaires
binaires : | binaire binaires
binaires : OPINF 
				| OPSUP
				| OPINFEG 
				| OPSUPEG 
...
suffixe : PAROUV PARFER
				| PAROUV expression virg PARFER
				| CROOUV virg CROFER

virg : expression
			|	 expression PTVIRG virg
