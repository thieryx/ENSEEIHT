...
package ada_main is
   ...
   u00333 : constant Version_32 := 16#f9c7ed70#;
   ...
   u00398 : constant Version_32 := 16#3160a4fc#;
   pragma Export (C, u00398, "lr__synchroB");
   u00399 : constant Version_32 := 16#6f87cbb4#;
   pragma Export (C, u00399, "lr__synchroS");
   u00400 : constant Version_32 := 16#b8f36aef#;
   pragma Export (C, u00400, "lr__synchro__basiqueB");
   u00401 : constant Version_32 := 16#98c199c5#;
   pragma Export (C, u00401, "lr__synchro__basiqueS");
   ...
   u00457 : constant Version_32 := 16#8fd179ec#;
   pragma Export (C, u00457, "lr__synchro__exclusionB");
   u00458 : constant Version_32 := 16#13aefc59#;
   pragma Export (C, u00458, "lr__synchro__exclusionS");
   u00459 : constant Version_32 := 16#585bd2e9#;
   pragma Export (C, u00459, "lr__synchro__prioredacteurB");
   u00460 : constant Version_32 := 16#bd3c25b5#;
   pragma Export (C, u00460, "lr__synchro__prioredacteurS");
   u00461 : constant Version_32 := 16#b864cb2d#;
   pragma Export (C, u00461, "lr__synchro__serveurB");
   u00462 : constant Version_32 := 16#5ea757cf#;
   pragma Export (C, u00462, "lr__synchro__serveurS");
   u00463 : constant Version_32 := 16#ec9cfed1#;
   pragma Export (C, u00463, "system__random_numbersB");
   u00464 : constant Version_32 := 16#852d5c9e#;
   pragma Export (C, u00464, "system__random_numbersS");
   u00465 : constant Version_32 := 16#e0ac52ca#;
   pragma Export (C, u00465, "system__random_seedB");
   u00466 : constant Version_32 := 16#1d25c55f#;
   pragma Export (C, u00466, "system__random_seedS");
   u00467 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00467, "system__val_unsB");
   u00468 : constant Version_32 := 16#621b7dbc#;
   pragma Export (C, u00468, "system__val_unsS");
   u00469 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00469, "system__val_intB");
   u00470 : constant Version_32 := 16#0e90c63b#;
   pragma Export (C, u00470, "system__val_intS");
   ...
   --  lr%s
   --  lr.synchro%s
   --  lr.synchro.serveur%s
   --  lr.synchro.prioredacteur%s
   --  lr.synchro.prioredacteur%b
   --  lr.synchro.exclusion%s
   --  lr.synchro.exclusion%b
   --  lr.synchro.basique%s
   --  lr.synchro.basique%b
   --  lr.synchro.serveur%b
   --  lr.synchro%b
   --  pango%s
   --  pango.enums%s
   --  pango.enums%b
